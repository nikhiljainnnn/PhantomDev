...
3. Write a comprehensive PR description in GitHub Markdown.

The PR description should include:
   - ## Summary (what this PR does in 2-3 sentences)
   - ## Changes (bullet list of files changed and what each does)
...
Write the full PR description inside a markdown code block:
